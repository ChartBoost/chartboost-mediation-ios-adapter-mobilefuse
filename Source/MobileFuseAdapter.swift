...
final class MobileFuseAdapter: PartnerAdapter {
    ...
    private var initializationDelegate: MobileFuseAdapterInitializationDelegate? // swiftlint:disable:this weak_delegate
    ...
    var configuration: PartnerAdapterConfiguration.Type { MobileFuseAdapterConfiguration.self }
